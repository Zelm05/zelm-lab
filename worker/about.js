...
// ===================================================================
import { json, checkRateLimit, getClientIP } from './auth.js';
import { makePasswordRecord, verifyPassword, verifySession } from './auth.js';
...
export async function aboutChangePassword(request, env) {
  // P0-2：关于页密码是站长专属写接口，必须查 sessions 表
